    ...
    return (
        <section className='projectdetailsphotoblock'>
            <div onClick={() => {
                ...
                <img src={`http://localhost:5000${data.img}`} className="projectdetailsphotoblock-photo" />
            ...
            <div onClick={() => {
                ...
                <img src={`http://localhost:5000${data.img}`} className="projectdetailsphotoblock-photo-fullscreen" />
            </div>
        </section>
    )
}
