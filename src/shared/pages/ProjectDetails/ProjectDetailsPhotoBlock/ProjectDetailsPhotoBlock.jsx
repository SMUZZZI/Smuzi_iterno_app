    ...
    return (
        <section className='projectdetailsphotoblock'>
            <div onClick={() => {
                ...
                <img src={`http://45.146.166.237:5000${data.img}`} className="projectdetailsphotoblock-photo" />
            ...
            <div onClick={() => {
                ...
                <img src={`http://45.146.166.237:5000${data.img}`} className="projectdetailsphotoblock-photo-fullscreen" />
            </div>
        </section>
    )
}
